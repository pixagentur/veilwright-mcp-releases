 ...
 * request path this client fetches (`/wp-json/veilwright/v1/system`) —
...
export class WpClient {
    ...
    async doMultipartRequest(path, body, contentType) {
        const headers = {
            ...this.signer.buildHeaders('POST', signaturePath(path), body, this.credentials.keyId, this.credentials.secret),
