/**
 * In-memory "active site" selection, set via the site_select tool.
 *
 ...
 * open against different sites, one calling site_select can silently
...
export class SessionState {
    ...
    requireActiveSite() {
        if (this.activeSiteId === null) {
            throw new Error('No active site selected. Call site_select first.');
        }
        return this.activeSiteId;
    }
}
